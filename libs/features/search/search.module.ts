...
import { SearchFiltersComponent, SingleFilterComponent, SubFilterComponent, ResultsHeaderComponent,
...
const declarations = [
  ...
  // Containers
  SearchFiltersComponent, SingleFilterComponent, SubFilterComponent, ResultsHeaderComponent, SearchResultsComponent
];
