...
@Injectable()
export class RelationalExchangeJobSearchSingleFilterEffects {
  ...
  searchEmployeeAggregations = this.infiniteScrollEffectsService.infiniteScrollActions$(ScrollIdConstants.SEARCH_SINGLED_FILTER).pipe(
    ...
    switchMap( data => {
      ...
      return this.exchangeJobSearchApiService.getRelationalExchangeJobSearchAggregationResults(request).pipe(
