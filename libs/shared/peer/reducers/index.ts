...
// Select Feature Area
export const selectSharedPeerState = createFeatureSelector<SharedPeerState>('sharedPeer');

// Feature Selectors
export const selectExchangeListState = createSelector(selectSharedPeerState, (state: SharedPeerState) => state.exchangeList);
