...
import { HeaderComponent, UserMenuComponent, UserMenuAvatarComponent } from './components';
...
@NgModule({
  ...
  declarations: [HeaderComponent, UserMenuComponent, UserMenuAvatarComponent, LayoutWrapperComponent],
