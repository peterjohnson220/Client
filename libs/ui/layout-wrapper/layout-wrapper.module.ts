...
import { HeaderComponent, LeftSidebarComponent, RightSidebarComponent, UserMenuComponent } from './components';
...
@NgModule({
  ...
  declarations: [HeaderComponent, LeftSidebarComponent, RightSidebarComponent, UserMenuComponent, LayoutWrapperComponent ],
