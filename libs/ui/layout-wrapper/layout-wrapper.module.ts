...
import { HeaderComponent, UserMenuComponent, LeftSidebarComponent, RightSidebarComponent, FooterComponent } from './components';
...
@NgModule({
  ...
  declarations: [HeaderComponent, UserMenuComponent, LeftSidebarComponent, RightSidebarComponent, FooterComponent, LayoutWrapperComponent],
