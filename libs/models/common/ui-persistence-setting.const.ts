export class UiPersistenceSettingConstants {
  static readonly PeerAccessRequested = 'PeerAccessRequested';
  static readonly RightSideBarIsOpen = 'RightSideBarIsOpen';
  static readonly SelectedExchangeId = 'SelectedExchangeId';
