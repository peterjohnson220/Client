...
export const JobBasedSearchFilterMappingDataObj: SearchFilterMappingDataObj = {
  'job_family': {
...
export const GradeBasedSearchFilterMappingDataObj: SearchFilterMappingDataObj = {
  'job_family': {
    Type: FilterType.Multi,
    BackingField: 'job_family',
    DisplayName: 'Job Family',
