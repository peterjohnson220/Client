export class ColumnTemplateService {
  ...
  static configureJobRangeTemplates(columnTemplateRefs) {
    return {
      ...
      ['Tertile_First']: {Template: columnTemplateRefs['rangeValue']},
      ['Tertile_Second']: {Template: columnTemplateRefs['rangeValue']},
      ['Quartile_First']: {Template: columnTemplateRefs['rangeValue']},
      ['Quartile_Second']: {Template: columnTemplateRefs['rangeValue']},
      ['Quintile_First']: {Template: columnTemplateRefs['rangeValue']},
      ['Quintile_Second']: {Template: columnTemplateRefs['rangeValue']},
      ['Mid']: {Template: columnTemplateRefs['mid']},
      ['Quintile_Third']: {Template: columnTemplateRefs['rangeValue']},
      ['Quintile_Fourth']: {Template: columnTemplateRefs['rangeValue']},
