export class ModelSettingsModalConstants {
  public static MIN_SPREAD_TOOL_TIP = 'The minimum range spread calculation is (midpoint) / (1 + min range spread value)';
  public static MAX_SPREAD_TOOL_TIP = 'The maximum range spread calculation is (min value) * (1 + (min range spread + max range spread))';
