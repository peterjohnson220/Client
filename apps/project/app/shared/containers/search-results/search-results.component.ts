...
export class SearchResultsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.jobResults$ = this.store.select(fromSharedSearchReducer.getResults);
    this.loadingResults$ = this.store.select(fromSharedSearchReducer.getLoadingResults);
    this.loadingMoreResults$ = this.store.select(fromSharedSearchReducer.getLoadingMoreResults);
    this.hasMoreResultsOnServer$ = this.store.select(fromSharedSearchReducer.getHasMoreResultsOnServer);
    this.projectSearchContext$ = this.store.select(fromSharedSearchReducer.getProjectSearchContext);
    this.error$ = this.store.select(fromSharedSearchReducer.getSearchResultsError);
  }
