...
import * as fromSharedProjectReducer from '../../reducers';
...
describe('Project - Add Data - Job Result', () => {
  ...
  let store: Store<fromSharedProjectReducer.State>;
    ...
    TestBed.configureTestingModule({
      imports: [
        StoreModule.forRoot({
          ...
          project_shared: combineReducers(fromSharedProjectReducer.reducers)
        })
      ],
