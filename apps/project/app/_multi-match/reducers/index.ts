...
import { SharedProjectState } from '../../survey-search/reducers';


// Feature area state
export interface MultiMatchState extends SharedProjectState {
...
export interface State extends fromRoot.State {
  project_multiMatch: MultiMatchState;
}
...
// Select Feature Area
export const selectFeatureAreaState = createFeatureSelector<MultiMatchState>('project_multiMatch');
