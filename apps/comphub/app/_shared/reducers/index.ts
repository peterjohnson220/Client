...
export interface State extends fromRoot.State {
  comphub_shared: ComphubSharedState;
}
...
// Select Feature Area
export const selectFeatureAreaState = createFeatureSelector<ComphubSharedState>('comphub_shared');

// feature selectors

export const selectJobsCardState = createSelector(
  selectFeatureAreaState,
  (state: ComphubSharedState) => state.jobsCard
);

export const selectComphubPageState = createSelector(
  selectFeatureAreaState,
  (state: ComphubSharedState) => state.comphubPage
);

export const selectMarketsCardState = createSelector(
  selectFeatureAreaState,
  (state: ComphubSharedState) => state.marketsCard
);

export const selectDataCardState = createSelector(
  selectFeatureAreaState,
  (state: ComphubSharedState) => state.dataCard
);

export const selectSummaryCardState = createSelector(
  selectFeatureAreaState,
  (state: ComphubSharedState) => state.summaryCard
);

export const selectAddPayMarketFormState = createSelector(
  selectFeatureAreaState,
  (state: ComphubSharedState) => state.addPayMarketForm
);
