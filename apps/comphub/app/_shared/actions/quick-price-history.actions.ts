...
export const GET_JOB_PRICED_HISTORY_SUMMARY = '[Comphub/Shared/Quick Price History Modal] Get Job Priced History Summary';
export const GET_JOB_PRICED_HISTORY_SUMMARY_SUCCESS = '[Comphub/Shared/Quick Price History Modal] Get Job Priced History Summary Success';
export const GET_JOB_PRICED_HISTORY_SUMMARY_ERROR = '[Comphub/Shared/Quick Price History Modal] Get Job Priced History Summary Error';
