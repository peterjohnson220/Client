import { ChangeDetectionStrategy, ChangeDetectorRef, Component, Directive, HostListener, Injectable, OnDestroy, OnInit } from '@angular/core';
...
@Directive()
@Injectable()
export class ComphubBasePageDirective implements OnInit, OnDestroy {
