...
import { faArrowAltCircleUp } from '@fortawesome/pro-solid-svg-icons/faArrowAltCircleUp';
...
export const faIcons = [
  ...
  fasBuilding, falBuilding, faPencil, faFilePdf, faFileWord, faFileImage, faFile
];
