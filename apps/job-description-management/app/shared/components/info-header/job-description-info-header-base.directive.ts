...
import * as fromJobDescriptionAppliesToReducers from 'libs/features/jobs/job-description-management/reducers/index';
...
export abstract class JobDescriptionInfoHeaderBaseDirective implements OnInit, OnChanges {
  ...
  private buildJobInfoFieldRows() {
    ...
    const jobInfoFields = this.jobInformationFields.filter(x =>
      !(this.jobDescription['JobDescriptionStatus'] === 'Published' && x.ShowFieldInView === false));
