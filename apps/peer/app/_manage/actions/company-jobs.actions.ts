...
export const SET_MAPPED_EXCHANGE_JOB = '[Peer Manage/Company Jobs] Set Mapped Exchange Job';
...
export class SetMappedExchangeJob implements Action {
  readonly type = SET_MAPPED_EXCHANGE_JOB;
