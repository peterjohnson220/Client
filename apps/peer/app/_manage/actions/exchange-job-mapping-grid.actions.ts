...
export const SET_ACTIVE_EXCHANGE_JOB_BY_TITLE = '[Peer Main/Exchange Job Mapping] Set Active Exchange Job By Title'
...
export class SetActiveExchangeJobByJobTitle implements Action {
  readonly type = SET_ACTIVE_EXCHANGE_JOB_BY_TITLE;
...
export type Actions
  ...
  | SetActiveExchangeJobByJobTitle;
