...
export const EXPORT_EMPLOYEES = '[Total Rewards/Statement History] Export Employees';
export const CREATE_EMPLOYEES_EXPORT = '[Total Rewards/Statement History] Create Employees Export';
export const CREATE_EMPLOYEES_EXPORT_ERROR = '[Total Rewards/Statement History] Create Employees Export Error';
...
export class UpdatePdfIdToExport implements Action {
  ...
  constructor(public payload: { pdfId: string, exportMode: ExportMode }) {}
}

export class ExportEmployees implements Action {
  readonly type = EXPORT_EMPLOYEES;
}

export class CreateEmployeesExport implements Action {
  readonly type = CREATE_EMPLOYEES_EXPORT;
}

export class CreateEmployeesExportError implements Action {
  readonly type = CREATE_EMPLOYEES_EXPORT_ERROR;
...
export type StatementHistoryPageActions =
  ...
  UpdatePdfIdToExport |
  ExportEmployees |
  CreateEmployeesExport |
  CreateEmployeesExportError;
