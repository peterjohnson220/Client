  ...
  return createGridReducer(
    ...
    (featureState: State = initialState, featureAction: fromStatementsActions.Actions): State => {
      switch (featureAction.type) {
        ...
        case fromStatementsActions.OPEN_CREATE_NEW_STATEMENT_MODAL: {
          return {
            ...featureState,
            isCreateNewStatementModalOpen: true
          };
        }
        case fromStatementsActions.CLOSE_CREATE_NEW_STATEMENT_MODAL: {
          return {
            ...featureState,
            isCreateNewStatementModalOpen: false
          };
