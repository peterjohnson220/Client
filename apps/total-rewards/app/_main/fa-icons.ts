...
export const faIcons = [ faDollarSign, faPlus, faCopy, faFileAlt, faTrash, faTrashAlt, faPlay, faHistory, faCheck, faPencil, faEllipsisH, faCog, faTimes, faExternalLink ];