import { faDollarSign, faPlus, faCopy, faTrash, faTrashAlt, faFileAlt, faPlay, faHistory, faCheck, faPencil, faEllipsisH, faCog, faTimes,
  faImage, faSearch, faChevronLeft, faSlidersH, faUserSlash, faDownload
...
export const faIcons = [
  ...
  faImage, faSearch, faChevronLeft, faInfoCircle, faSlidersH, faUserSlash, faTrophyAlt, faDownload
];
