...
import { faUnlockAlt } from '@fortawesome/pro-solid-svg-icons/faUnlockAlt';
...
import { faTelescope } from '@fortawesome/pro-solid-svg-icons/faTelescope';
export const faIcons = [
  faBuilding, faBriefcase, faUnlockAlt, faEnvelope,
  faAddressCard, faTrash, faClock, faTimes, faFilter, faTrashAlt,
  faGripVertical, faCheckCircle, faPencil, faTelescope
];
