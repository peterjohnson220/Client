...
import { SelfRegistrationValidationService } from './self-registration-validation.service';

let service: SelfRegistrationValidationService;

describe('SelfRegistrationValidationService', () => {
  beforeEach(() => {
    TestBed.configureTestingModule({ providers: [ SelfRegistrationValidationService ] });
    service = TestBed.get(SelfRegistrationValidationService);
  });
